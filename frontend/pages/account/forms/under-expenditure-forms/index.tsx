...
const UnderExpenditureFormTable = ({ records }: { records: any }) => {
  return (
    <DataTable
      minHeight={150}
      records={records ?? []}
      columns={[
        ...
        },
        {
          ...
          width: 80,
          render: (entry: any) => (
            <Anchor component={Link} href={`/account/forms/under-expenditure-forms/view/${entry?.id}/`}>
...
const MyUnderExpenditureForms = (props: IMyForms) => {
  ...
  return (
    <div>
      <Container size="lg" py={50}>
        ...
        <Stack>
          <Title>My Under Expenditure Forms</Title>
          <UnderExpenditureFormTable records={my_forms} />
        </Stack>

        {
          user_ ? user_?.profile?.checker ? (
            <Stack>
              <Title>Under Expenditure Forms to Check</Title>
              <UnderExpenditureFormTable records={forms_to_check} />
            </Stack>
          ) : null : null
        }

        {
          user_ ? user_?.profile?.approver ? (
            <Stack>
              <Title>Under Expenditure to Approve</Title>
              <UnderExpenditureFormTable records={forms_to_approve} />
            </Stack>
          ) : null : null
        }
...
MyUnderExpenditureForms.PageLayout = HeaderAndFooterWrapper
export default MyUnderExpenditureForms