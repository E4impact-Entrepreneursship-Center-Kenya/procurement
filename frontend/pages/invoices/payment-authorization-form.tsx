...
const PaymentAuthorization = () => {
    return (
        <div>
            <Head>
                <title>{`${APP_NAME} ${SEPARATOR} Payment Authorization`}</title>
            </Head>
            <CustomHeading title="Payment Authorization Form" />
...
PaymentAuthorization.PageLayout = HeaderAndFooterWrapper
